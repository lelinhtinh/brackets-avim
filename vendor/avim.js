...
function AVIM() {
    ...
    this.start = function (obj, key) {
        ...
        if (method === 0) {
            var arr = [],
                check = [AVIMAutoConfig.telex, AVIMAutoConfig.vni, AVIMAutoConfig.viqr, AVIMAutoConfig.viqrStar];
    ...
    this.findC = function (w, k, sf) {
        ...
        var str = "",
            ...
            uw = this.up(w),
            tv, g;
        var DAWEOFA = this.up(this.aA.join() + this.eA.join() + this.mocA.join() + this.trangA.join() + this.oA.join() + this.english),
            h, uc;
        ...
        if ((c == 1) || (uk == this.Z)) {
            ...
            var c2 = 0,
                fdconsonant, sc = "BCD" + this.fcc(272) + "GHKLMNPQRSTVX",
    ...
    this.main = function (w, k, i, a, noNormC) {
        ...
        var sfa = [this.ds1, this.as1, this.es1, this.os1, this.mocs1, this.trangs1],
            by = [],
            sf = [],
            method = AVIMGlobalConfig.method,
            h, g;
    ...
    this.normC = function (w, k, i) {
        var uk = this.up(k),
            u = this.repSign(null),
            fS, c, j, h, space = (k.charCodeAt(0) == 32) ? true : false;
        if (!this.is_ie && space) {
            return;
        }
    ...
    this.keyDownHandler = function (e) {
        ...
        if (e == "iframe") {
            ...
            key = this.frame.event.keyCode;
        } else {
            key = (!this.is_ie) ? e.which : window.event.keyCode;
        }
        if (key == 123) {
